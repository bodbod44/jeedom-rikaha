...
Vous retrouverez le détail complet des mises à jour sur https://github.com/bodbod44/jeedom-rikaha (init : https://github.com/openhautomation/rikaha)
...
- Corrections pour Debian12
  ...
  - Correction d'une condition sur la variable $data ([Signalement](https://community.jeedom.com/t/compatibilite-rikaha-debian-12/130063/11))
- Mise en place du choix de la fréquence de rafraichissement des données depuis le cloud pour chaque équipement (10 min par défaut)
- Ajout d'une icône "Documentation plugin" dans la page de configuration (qui redirige vers https://bodbod44.github.io/jeedom-rikaha/fr_FR/)
- Ajout d'une icône "Manuels utilisateur" dans la page de configuration (qui redirige vers https://www.rika.fr/downloads)
...
# 30/10/2018 (stable) /!\ attention après la mise à jour, il est nécessaire de supprimer puis, de créer à nouveau vos équipements
...
# 21/09/2018 (stable) /!\ attention après la mise à jour, il est nécessaire de supprimer puis, de créer à nouveau vos équipements
- Ajout de la modification de la puissance de chauffe. Le range est compris entre 30 et 100 % par pas de 5.

# 19/09/2018 (stable) /!\ attention après la mise à jour, il est nécessaire de supprimer puis, de créer à nouveau vos équipements
